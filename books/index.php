                                    ...
                                    if ( strlen( $edition ) == 0 ) {
                                        ...
                                        if ( strlen( $ISBN ) == 0 ) {
                                            ...
                                            if ( strlen( $Authorname ) == 0 ) {
                                                ...
                                                if ( mysqli_query( $conn, "INSERT INTO books1(ISBN, Book_Title, Book_Type, Author_Name, Quantity, Purchase_Date, Edition, Price, Pages, Publisher) VALUES('" . $ISBN  . "', '" . strtoupper( $Booktitle ) . "', '" . strtoupper( $Booktype ) . "', '". $Authorname ."','" . $quantity . "', '".$purchasedate  . "','" . $edition . "', '" . $Price . "', '".$pages. "','" . $publisher. "')" ) ) {
