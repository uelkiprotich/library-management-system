...
if ( isset( $_POST[ 'text' ] ) ) {
    $searc = mysqli_real_escape_string( $conn, $_POST[ 'text' ] );
    if ( strlen( $searc ) == '' ) {
        $_SESSION[ 'search' ] = 'Nothing Found';
...
<div class = 'venom'>
<?php
$query = "SELECT * FROM books1 WHERE Book_Title LIKE '%".$search."%'" ;
...
?>
<?php
$query1 = "SELECT * FROM books1 WHERE Book_Type LIKE '%".$search."%'" ;
...
<?php
$query1 = "SELECT * FROM books1 WHERE Author_Name LIKE '%".$search."%'" ;
...
<?php
$query1 = "SELECT * FROM books1 WHERE Publisher LIKE '%".$search."%'" ;
...
?>
<?php
$query1 = "SELECT * FROM books1 WHERE Edition LIKE '%".$search."%'" ;
