...
<title><?php echo strtoupper( $_SESSION[ 'First_name' ] )  ?>'s Details | LIBRARY MANAGEMENT SYSTEM</title>
</head>
...
<body>
    <nav>
        ...
        <div class="venomt" style="overflow: scroll;">   
<div class="avat">
  <img src="<?php echo './upload/'.$_SESSION['realimage']  ?>" alt="Avatar" class="avatar1">
  <a href="<?php echo './upload/'.$_SESSION['realimage']  ?>" download rel="noopener noreferrer" target="_blank">
   Download Image
</a>
  ...
  <input id="submit" type='submit' value='Upload' name='upload'>
    ...
    <div class="card1">
       ...
       <a>Reg_Number:-</a> <?php echo $_SESSION['RegNumber']?><br>
